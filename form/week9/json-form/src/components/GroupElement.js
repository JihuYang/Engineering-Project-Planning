...
const Element = ({ group : { group_name, fields } }) => {
    ...
    ({ fields: { field_type, field_id, field_label, field_placeholder, field_value, field_options, field_min, field_max, field_pattern, field_cols,field_rows, field_maxlength } }) => {
